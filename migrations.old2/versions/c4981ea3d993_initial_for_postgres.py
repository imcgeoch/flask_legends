...
Revision ID: c4981ea3d993
Revises: 
Create Date: 2019-07-21 17:06:49.249682
...
def upgrade():
    ...
    sa.Column('goal', sa.Enum('create a great work of art', 'immortality', 'master a skill', 'start a family', 'rule the world', 'fall in love', 'see the great natural sites', 'become a legendary warrior', 'bring peace to the world', 'make a great discovery', 'craft a masterwork', name='goal_types'), nullable=False),
    sa.ForeignKeyConstraint(['df_world_id'], ['df_world.id'], ondelete='CASCADE'),
    ...
    sa.Column('link_type', sa.Enum('child', 'spouse', 'deity', 'apprentice', 'mother', 'father', 'former apprentice', 'master', 'prisoner', 'imprisoner', 'former master', name='hf_link_type'), nullable=True),
    sa.ForeignKeyConstraint(['df_world_id'], ['df_world.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('woundee_race', sa.Integer(), nullable=True),
    sa.Column('woundee_caste', sa.Integer(), nullable=True),
    sa.Column('body_part', sa.Integer(), nullable=True),
    sa.Column('injury_type', sa.Integer(), nullable=True),
    sa.Column('part_lost', sa.Integer(), nullable=True),
    ...
    sa.Column('type', sa.Enum('cave', 'fortress', 'dark fortress', 'forest retreat', 'town', 'vault', 'hillocks', 'dark pits', 'hamlet', 'tomb', 'mountain halls', 'camp', 'lair', 'shrine', 'tower', name='site_types'), nullable=True),
    sa.Column('civ_id', sa.Integer(), nullable=True),
    ...
    sa.Column('type', sa.Enum('underworld spire', 'inn tavern', 'market', 'temple', 'dungeon', 'keep', 'tomb', 'mead hall', 'library', name='structure_types'), nullable=True),
